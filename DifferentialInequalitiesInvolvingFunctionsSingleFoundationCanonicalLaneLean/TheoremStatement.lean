import DifferentialInequalitiesInvolvingFunctionsSingleFoundationCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  functionConstrainedStatement := "function-constrained theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
...
def FunctionConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "function_constrained" ∧
